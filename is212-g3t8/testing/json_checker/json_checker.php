...
$url = 'http://localhost/project-g3t8/app/json';
...
function runTestCases($url, $directories, $json_ext) {
    ...
    $token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VybmFtZSI6ImFkbWluIiwiZGF0ZXRpbWUiOiIyMDE5LTEwLTI3IDE4OjQ5OjIzIn0.4Up0NZkvzYXxiChaOwVAkrQ59LIrpobHMctEnXWE8Y0';
     // to keep token returned after a successful authentication
    $test_results = [];
    ...
    foreach ($in_files as $filename) {
        ...
        if ( strcasecmp( $file_ext, 'zip') == 0) {
            ...
            if ($json_api == 'authenticate_autotest' || $json_api == "authenticate") {
                // authenticate
